...
from network.MutiHeadAttention import MultiHeadAttention  # 替换成你的自定义层所在模块
...
model = keras.models.load_model("./model/weightsbestfinal_IMSNet.h5",custom_objects={"MultiHeadAttention": MultiHeadAttention})
