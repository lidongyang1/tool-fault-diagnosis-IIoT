...
from network.Model_define import get_custom_objects,Network_MSCNet
...
output = Network_MSCNet(input1, input2, input3)
...
model.summary()
filepath = "./model/weightsbestfinal_MSCNet.h5"
...
np.save('./loss/train_losses_MSCNet.npy', np.array(history.train_losses))
np.save('./loss/val_losses_MSCNet.npy', np.array(history.val_losses))