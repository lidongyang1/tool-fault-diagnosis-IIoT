...
from network.Model_define import get_custom_objects,Network_IMSNet
...
output = Network_IMSNet(input1, input2, input3)
...
model.summary()
filepath = "./model/weightsbestfinal_IMSNet.h5"
...
np.save('./loss/train_losses_IMSNet.npy', np.array(history.train_losses))
np.save('./loss/val_losses_IMSNet.npy', np.array(history.val_losses))
